...
import ma.enset.digital-bankingbackend.dtos.PasswordChangeRequest;
import ma.enset.digital-bankingbackend.dtos.PasswordResetRequest;
...
import ma.enset.digital-bankingbackend.services.UserService;
...
public class UserController {
    ...
    public String resetPassword(@RequestBody PasswordResetRequest request, Principal principal) {
        ...
        actionLogServiceImpl.log(principal.getName(), "RESET_PASSWORD",
                "Reset password for user: " + request.getUsername());
    ...
    public ResponseEntity<User> createUser(@RequestBody CreateUserRequest request, Principal principal) {
        ...
        actionLogServiceImpl.log(principal.getName(), "CREATE_USER",
                "Created user with username: " + created.getUsername());
